...
export const WorkPlacement = () => {
  ...
  return (
    <>
      ...
      <group
        position={ isMobile ? [-1.7, -0, -4] : [-2, 0, 0] }
      >
        ...
        <ExpandableText
          ...
          groupPosition={ isMobile ? [1.6, -0.7, 8] : [1, 0.2, 1] }
          planeInitialSize={ [3.3, 0.6] }
          planeExpandedSize={ isMobile ? [1.5, 0.5] : [2, 0.5] }
          expandedTextLength={ isMobile ? 1.5 : 2 }
        />
      </group>
      ...
      <group
        ...
        position={ isMobile ? [0, 0.2, -4] : [0, 0, 0] }
      >
